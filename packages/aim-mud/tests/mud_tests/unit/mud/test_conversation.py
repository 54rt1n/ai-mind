...
class TestMUDConversationManagerFlushToCVM:
    ...
    async def test_flush_to_cvm_marks_entries_saved(self, conversation_manager, mock_redis):
        ...
        # Verify the updated entry has saved=True and doc_id was assigned
        ...
        # doc_id is generated by ConversationMessage.create() - just verify it exists
        assert updated_entry.doc_id is not None
        assert len(updated_entry.doc_id) > 0
