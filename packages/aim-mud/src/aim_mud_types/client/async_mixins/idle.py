# aim-mud-types/client/async_mixins/idle.py
# AI-Mind (C) 2025 by Martin Bukowski is licensed under CC BY-NC-SA 4.0
"""Idle active flag operations."""
...
class IdleMixin:
    """Idle active flag Redis operations.
    ...
    async def is_idle_active(self: "BaseAsyncRedisMUDClient", agent_id: str) -> bool:
