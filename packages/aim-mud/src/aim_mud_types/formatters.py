# aim_mud_types/formatters.py
# AI-Mind (C) 2025 by Martin Bukowski is licensed under CC BY-NC-SA 4.0
"""Shared MUD event formatting functions.

This module provides functions to format MUDEvent objects into human-readable
strings suitable for inclusion in chat context. These formatters are used by
both the AI-Mind agent workers and any other components that need to display
MUD events in a consistent format.
...
- Self-actions are formatted in first person ("You successfully...")
- System events use [brackets]
"""

from aim_mud_types.models import EventType, MUDEvent
