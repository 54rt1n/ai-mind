...
from .strategy import PhasedTurnProcessor, AgentTurnProcessor
...
class TurnsMixin:
    ...
    def _extract_speak_text_from_tool_call(response: str) -> Optional[str]:
        """Backward compatibility wrapper for extract_speak_text_from_tool_call function."""
        return extract_speak_text_from_tool_call(response)
